// Law: RemainingTimeTargetLaw — PredictionProblem<RemainingTime> is lawfully constructible; RemainingTime is a distinct prediction target witness from NextActivity and RiskScore
