...
// Law: WfNetClaimedStateLaw — WfNetConst::claim_sound() re-tags Unknown to Claimed at the type level; no runtime check occurs; the Claimed type is distinct from Unknown
