...
//! Compile-PASS (intentional): This demonstrates the WEAKER migrated API that CAN be called without a witness.
//! This fixture documents the forgeability gap in the migrated WfNet<S> API.
//!
