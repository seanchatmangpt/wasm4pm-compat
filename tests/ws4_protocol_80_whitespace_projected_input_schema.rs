...
#[test]
fn whitespace_only_projected_input_schema_is_refused() {
    ...
    let b = ProtocolBundle {
        ...
        capabilities: vec![c],
        surfaces: vec![
            SurfaceBinding::projected("cap", SurfaceKind::Cli, "d", " \t ", "out"),
    ...
    assert!(b.validate().contains(&ProtocolRefusal::EmptySurfaceSchema {
