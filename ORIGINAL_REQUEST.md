...
# MISSION: wasm4pm-compat v26.6.8 Documentation Rebase
...
- Do NOT modify the version field in Cargo.toml. Keep it at `26.6.8`. All documentation, checklists, and reports must refer to the targeted release version `26.6.8`. Explain this manifest version discrepancy in the audit/verification/final review reports.
...
- Find all stale references to: version 26.6.8, stable/MSRV, ts feature, wasm feature, generated/source-caste language, engine behavior inside compat, ggen-specific implementation.
- Produce a short findings note in `docs/reports/v26.6.8-doc-audit.md`.
...
- Must say v26.6.8 (while acknowledging Cargo.toml version field is currently locked at 26.6.8).
...
- version is `26.6.8` (noting that Cargo.toml remains at `26.6.8` due to user constraint)
...
Write `docs/reports/v26.6.8-verification-report.md`. Indicate that package version mismatch (26.6.8 vs 26.6.8) is a known constraint.
...
- Create/update `docs/reports/v26.6.8-final-doc-review.md`. Final review must state `READY_FOR_HUMAN_REVIEW` or `BLOCKED` with reasons.
...
At minimum, produce or update:
  ...
  docs/reports/v26.6.8-doc-audit.md
  docs/reports/v26.6.8-verification-report.md
  docs/reports/v26.6.8-final-doc-review.md

---

# HARD REFUSAL CONDITIONS
Stop and report BLOCKED if:
- version cannot be reconciled as `26.6.8` (except for Cargo.toml version field which MUST remain 26.6.8 as requested)
...
# MISSION: wasm4pm-compat v26.6.8 Publish Verification and Git Hygiene Audit
# MODE: Google Antigravity CLI — 10 Subagent Team
# TARGET REPO: wasm4pm-compat
...
3. Save the results and outputs of these verification runs to:
   `docs/reports/v26.6.8-publish-readiness-hygiene-report.md`

4. Update `docs/reports/v26.6.8-implementation-requirements-ledger.md` (specifically marking trybuild and git hygiene items) and `docs/reference/publish-checklist.md` accordingly based on your findings.
