...
- **Root Crate (`wasm4pm-compat`)**: Configured at version `26.6.23` in the root `Cargo.toml`.
- **Subcrates (`c8-time`, `c8-receipts`, `c8-instruments`, `c8-market`, `c8-adversary`)**: Configured at version `26.6.23`.
- **Derived Manifests (`ggen-witness.toml`, `ggen/package.toml`)**: Also at version `26.6.23`.
...
- [Verification Report](../reports/v26.6.23-verification-report.md)
