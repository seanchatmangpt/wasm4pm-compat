...
This document explains the conceptual underpinnings and technical implementation of the "no format laundering" covenant in `wasm4pm-compat` version `26.6.23`.
