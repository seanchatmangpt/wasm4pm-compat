...
This document details the architectural rationale for the "structure-only" design of `wasm4pm-compat` version `26.6.5` and explains how it decouples data shapes from active process-mining engines like `wasm4pm`.
