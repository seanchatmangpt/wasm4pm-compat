# DoD Boundary and Evidence Gates Compliance Audit

## Executive Summary
This report audits compliance of the `wasm4pm-compat` codebase (specifically `/Users/sac/wasm4pm-compat/src`) against the DoD Boundary and Evidence gates:
...
- [ImportFormat::import](file:///Users/sac/wasm4pm-compat/src/formats.rs#L179-L206) enforces a boundary: it accepts only an unadmitted `FormatEnvelope` and returns an `Admission` or a `Refusal` (never a raw value).
- [ExportFormat::export](file:///Users/sac/wasm4pm-compat/src/formats.rs#L218-L233) accepts a typed source and a `LossPolicy`, returning a `FormatExport` or a refusal.
...
### Findings:
- There are **16 distinct refusal enums** defined throughout the codebase, representing domain-specific laws:
  ...
  3. [ConformanceRefusal](file:///Users/sac/wasm4pm-compat/src/conformance.rs#L815)
  4. [DeclareRefusal](file:///Users/sac/wasm4pm-compat/src/declare.rs#L585) & [OcDeclareRefusal](file:///Users/sac/wasm4pm-compat/src/declare.rs#L554)
  5. [DfgRefusal](file:///Users/sac/wasm4pm-compat/src/dfg.rs#L416)
  6. [EventLogRefusal](file:///Users/sac/wasm4pm-compat/src/eventlog.rs#L517)
  7. [InteropRefusal](file:///Users/sac/wasm4pm-compat/src/interop.rs#L302)
  8. [OcelRefusal](file:///Users/sac/wasm4pm-compat/src/ocel.rs#L806)
  9. [OcpqRefusal](file:///Users/sac/wasm4pm-compat/src/ocpq.rs#L835)
  10. [PetriRefusal](file:///Users/sac/wasm4pm-compat/src/petri.rs#L1543)
  11. [PowlRefusal](file:///Users/sac/wasm4pm-compat/src/powl.rs#L682)
  12. [PredictionRefusal](file:///Users/sac/wasm4pm-compat/src/prediction.rs#L333)
  13. [ProcessTreeRefusal](file:///Users/sac/wasm4pm-compat/src/process_tree.rs#L539)
  14. [ReceiptRefusal](file:///Users/sac/wasm4pm-compat/src/receipt.rs#L362)
  15. [XesRefusal](file:///Users/sac/wasm4pm-compat/src/xes.rs#L1095)
...
- The refusal path is represented by the `Err(Self::Reason)` variant. If the policy is `LossPolicy::RefuseLoss` and loss would occur, it must return a named refusal (e.g., `OcelRefusal::FlatteningLoss`).
- Realized examples can be found in [interop.rs:L696-736](file:///Users/sac/wasm4pm-compat/src/interop.rs#L696-L736) for `OcelToXesProjection` and `XesToOcedProjection`.
