...
**Generated:** 2026-05-30 | **Updated:** 2026-05-31 (graduation boundary targets named)  
...
| `COVERED_BY_GRADUATION_BOUNDARY` | 5 | #7, #8 (PM4Py), #9 (PMAx), #16 (YAWL Technical Manual), #21 (No AI Without PI!) — each entry now names specific `GraduationReason` variants |
