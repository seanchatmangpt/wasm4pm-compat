...
|---|---|---|---|
| **Crate Version** | Verify root version matches target release version (`26.6.4`). | ⚠️ | Known constraint: root version is `26.6.4`, while workspace subcrates (e.g. `c8-time`) and generated configs remain at `0.1.0`. |
