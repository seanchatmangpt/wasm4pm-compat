...
This document maps the public Rust module layout in `wasm4pm-compat` version `26.6.4` to their physical files. This mapping is compiled directly from the module declarations in `src/lib.rs`.
